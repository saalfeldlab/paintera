...
interface N5BackendRaw<D, T> : ConnectomicsRawBackend<D, T>, SourceStateBackendN5<D, T> {
	...
	companion object {
		...
		fun <D, T> createFrom(
			...
			offset: DoubleArray = DoubleArray(3) { 0.0 }): N5BackendRaw<D, T>
				where D: NativeType<D>,
					  D: RealType<D>,
