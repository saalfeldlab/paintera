...
class N5MetadataBackendSingleScaleDataset<D, T> constructor(
    private val metadataState: MetadataState,
    projectDirectory: Supplier<String>,
    propagationExecutorService: ExecutorService
) : N5BackendSingleScaleDataset<D, T>(metadataState.n5ContainerState.writer!!, metadataState.group, projectDirectory, propagationExecutorService)
...
open class N5BackendSingleScaleDataset<D, T> constructor(
