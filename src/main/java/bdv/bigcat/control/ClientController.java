 ...
 */
public class ClientController implements MouseListener, KeyListener
{
	protected class SocketListener extends Thread
	{
		final void handleMessage( final String json )
		{
			final Message msg = gson.fromJson( json, Message.class );

			System.out.println( "Message received" );
			System.out.println( json );

			System.out.println( "Type = " + msg.getType().name() );
			System.out.println( "Data Class = " + msg.getData().getClass().getCanonicalName() );
