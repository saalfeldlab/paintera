...
class GrowingStoreRandomAccessibleSingletonAccess< T extends Type< T > > implements RandomAccessible< T >
{
    ...
    public GrowingStoreRandomAccessibleSingletonAccess(
...
//        };
        ...
        GrowingStoreRandomAccessibleSingletonAccess<IntType> rra =
                new GrowingStoreRandomAccessibleSingletonAccess<>(img, factory);
