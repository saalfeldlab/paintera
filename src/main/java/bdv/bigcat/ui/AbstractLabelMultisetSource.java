...
abstract public class AbstractLabelMultisetSource implements Source< LabelMultisetType >
{
	...
	public AbstractLabelMultisetSource(
			final int setupId,
	...
	@Override
	abstract public RandomAccessibleInterval< LabelMultisetType > getSource( final int t, final int level );

	@Override
	public RealRandomAccessible< LabelMultisetType > getInterpolatedSource( final int t, final int level, final Interpolation method )
	{
		final ExtendedRandomAccessibleInterval< LabelMultisetType, RandomAccessibleInterval< LabelMultisetType > > extendedSource =
				Views.extendValue( getSource( t, level ), new LabelMultisetType() );
		switch ( method )
		{
		default:
	...
	@Override
	public LabelMultisetType getType()
	{
