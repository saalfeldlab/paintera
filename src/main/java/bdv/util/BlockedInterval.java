...
public class BlockedInterval< T > implements RandomAccessibleInterval< RandomAccessibleInterval< T > > {
	...
	/**
	 * @param source		Source to be wrapped.
	 * @param stepSize		Strides for each dimension
	 ...
	 * @param source		Source to be wrapped.
	 * @param stepSize		Strides for each dimension.
	 * @param value			Value for extending source.
	 ...
	 * @param source		Source to be wrapped.
	 * @param stepSize		Strides for each dimension.
	 * @param factory		Factory for extending source.
	 */
