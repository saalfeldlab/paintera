 ...
 */
public class AccessedBlocksRandomAccessible< T > extends AbstractWrappedInterval< RandomAccessibleInterval< T > > implements RandomAccessibleInterval< T >
{
	...
	{
		this( source, IntStream.range( 0, grid.numDimensions() ).map( grid::cellDimension ).toArray(), grid.getGridDimensions() );
	}

	public AccessedBlocksRandomAccessible( final RandomAccessibleInterval< T > source, final int[] blockSize, final long[] blockGridDimensions )
	{
		super( source );
	...
	public static void main( final String[] args )
	{
		...
		final AccessedBlocksRandomAccessible< LongType > tracker = new AccessedBlocksRandomAccessible<>( dummy, new CellGrid( dimensions, blockSize ) );
