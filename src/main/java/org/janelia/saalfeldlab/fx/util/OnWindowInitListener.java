...
public class OnWindowInitListener implements ChangeListener<Window>
{
	...
	@Override
	public void changed(final ObservableValue<? extends Window> observable, final Window oldValue, final Window
			newValue)
	{
	...
	{
		final OnWindowInitListener onWindowInit = new OnWindowInitListener(
				window -> window != null && window instanceof Stage,
				window -> stageConsumer.accept((Stage) window)
		);
