...
public class N5DataSource< D extends NativeType< D >, T extends Volatile< D > & NativeType< T > > extends RandomAccessibleIntervalDataSource< D, T >
{
	...
	{
		this( meta, transform, sharedQueue, name, priority, interpolation( meta.reader(), meta.dataset() ), interpolation( meta.reader(), meta.dataset() ) );
	}
	...
	public N5DataSource(
			...
			final Function< Interpolation, InterpolatorFactory< T, RandomAccessible< T > > > interpolation ) throws IOException
	{
		super(
	...
	private static < T extends NativeType< T > > Function< Interpolation, InterpolatorFactory< T, RandomAccessible< T > > > interpolation( final N5Reader n5, final String dataset ) throws IOException
	{
