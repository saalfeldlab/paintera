...
public class RealPickOneLabelMultisetType<M extends IntegerType<M>>
		implements RealPickOne.RealPickAndConvert<LabelMultisetType, M, M, LabelMultisetType>
{
	...
	public RealPickOneLabelMultisetType(final Predicate<M> pickThird, final BiPredicate<M, M> pickSecond)
	{
		super();
	...
	@Override
	public RealPickAndConvert<LabelMultisetType, M, M, LabelMultisetType> copy()
	{
		return new RealPickOneLabelMultisetType<>(pickThird, pickSecond);
	}
