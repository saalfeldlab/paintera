...
public class RealPickOneVolatileLabelMultisetType<M extends IntegerType<M>, VM extends Volatile<M>>
		implements RealPickOne.RealPickAndConvert<VolatileLabelMultisetType, VM, VM, VolatileLabelMultisetType>
{
	...
	public RealPickOneVolatileLabelMultisetType(final Predicate<M> pickThird, final BiPredicate<M, M> pickSecond)
	{
		super();
	...
	@Override
	public RealPickAndConvert<VolatileLabelMultisetType, VM, VM, VolatileLabelMultisetType> copy()
	{
		return new RealPickOneVolatileLabelMultisetType<>(pickThird, pickSecond);
	}
