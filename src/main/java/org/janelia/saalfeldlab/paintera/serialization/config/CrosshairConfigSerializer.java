		...
		JsonDeserializer< CrosshairConfig >
{
	...
	@Override
	public CrosshairConfig deserialize( final JsonElement json, final Type typeOfT, final JsonDeserializationContext context ) throws JsonParseException
	{
	...
	@Override
	public JsonElement serialize( final CrosshairConfig src, final Type typeOfSrc, final JsonSerializationContext context )
	{
