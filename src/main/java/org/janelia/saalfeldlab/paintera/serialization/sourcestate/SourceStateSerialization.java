...
public class SourceStateSerialization
{
	...
	private static abstract class AbstractSourceStateSerializer< S extends SourceState< ?, ? > > implements JsonSerializer< S >
	{
	...
	public static class SourceStateSerializerWithoutDependencies< S extends SourceState< ?, ? > > extends AbstractSourceStateSerializer< S >
	{
		@Override
	...
	public static class SourceStateSerializerWithDependencies< S extends SourceState< ?, ? > > extends AbstractSourceStateSerializer< S >
	{
	...
	private static abstract class AbstractSourceStateDeserializer< S extends SourceState< ?, ? >, C extends Converter< ?, ARGBType > >
			implements JsonDeserializer< S >
	{
				...
				final JsonDeserializationContext context ) throws JsonParseException
		{
			try
			{
				...
				{
					LOG.debug( "At least one (out of {}) dependency not initialized yet: {}", dependsOn.length, dependsOn );
					return null;
				}
	...
	public static abstract class SourceStateDeserializerWithoutDependencies< S extends SourceState< ?, ? >, C extends Converter< ?, ARGBType > >
	...
	public static abstract class SourceStateDeserializerWithDependencies< S extends SourceState< ?, ? >, C extends Converter< ?, ARGBType > >
			extends AbstractSourceStateDeserializer< S, C >
	{
