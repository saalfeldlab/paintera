		...
		JsonDeserializer< SimpleIntegerProperty >
{
	...
	@Override
	public SimpleIntegerProperty deserialize( final JsonElement json, final Type typeOfT, final JsonDeserializationContext context ) throws JsonParseException
	{
		return new SimpleIntegerProperty( Optional.ofNullable( ( Integer ) context.deserialize( json, Integer.class ) ).orElse( 0 ) );
	}
