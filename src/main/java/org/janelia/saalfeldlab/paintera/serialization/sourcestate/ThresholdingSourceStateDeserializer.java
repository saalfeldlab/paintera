...
public class ThresholdingSourceStateDeserializer implements JsonDeserializer< ThresholdingSourceState< ?, ? > >
{
	...
	public static class Factory implements StatefulSerializer.Deserializer< ThresholdingSourceState< ?, ? >, ThresholdingSourceStateDeserializer >
	{
	...
	@Override
	public ThresholdingSourceState< ?, ? > deserialize( final JsonElement el, final Type type, final JsonDeserializationContext context ) throws JsonParseException
	{
