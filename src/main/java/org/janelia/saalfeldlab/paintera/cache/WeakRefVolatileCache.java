...
public class WeakRefVolatileCache<K, V> implements VolatileCache<K, V> {
	...
	final class FetchEntry implements Callable<Void> {
		 ...
		 * valid.
		 *
		 * @throws ExecutionException if the entry could not be loaded. If the queue is handled by {@link FetcherThreads} then loading
		 *                            will be
	 ...
	 *
	 * @param hints specifies the budget priority level.
