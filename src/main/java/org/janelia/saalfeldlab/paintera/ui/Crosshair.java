...
public class Crosshair implements OverlayRendererGeneric< GraphicsContext >
{
	...
	private final ObjectBinding< Color > color = Bindings.createObjectBinding( () -> isHighlight.get() ? highlightColor.get() : regularColor.get(), isHighlight, highlightColor, regularColor );
