...
public class PainteraCommandLineArgs implements Callable< Boolean >
{
	...
	@Option( names = "--num-screen-scales", paramLabel = "NUM_SCREEN_SCALES", required = false, description = "Number of screen scales, defaults to 3" )
	private Integer numScreenScales;

	@Option( names = "--highest-screen-scale", paramLabel = "HIGHEST_SCREEN_SCALE", required = false, description = "Highest screen scale, restricted to the interval (0,1], defaults to 1" )
	private Double highestScreenScale;

	@Option( names = "--screen-scale-factor", paramLabel = "SCREEN_SCALE_FACTOR", required = false, description = "Scalar value from the open interval (0,1) that defines how screen scales diminish in each dimension. Defaults to 0.5" )
	private Double screenScaleFactor;

	@Option( names = "--screen-scales", paramLabel = "SCREEN_SCALES", required = false, description = "Explicitly set screen scales. Must be strictliy monotonically decreasing values in from the interval (0,1]. Overrides all other screen scale options.", arity = "1..*", split = "," )
	...
	public Boolean call() throws Exception
	{
		...
		screenScales = screenScales == null ? createScreenScales( numScreenScales, highestScreenScale, screenScaleFactor ) : screenScales;
