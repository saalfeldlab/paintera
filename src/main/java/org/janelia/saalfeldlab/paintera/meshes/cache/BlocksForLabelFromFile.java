...
public class BlocksForLabelFromFile implements InterruptibleFunction< Long, Interval[] >
{
	...
	public Interval[] apply( final Long t )
	{
		...
		{
			LOG.error( "Unable to read data from file at {} generated by pattern {} and id {} -- returning empty array: {}", path, pattern, t, e );
			return EMPTY_ARRAY;
		}
	}
	...
	private static class InvalidFileSize extends Exception
	{
		...
		{
			super( "Expected file size in bytes of integer multiple of " + SINGLE_ENTRY_BYTE_SIZE + " but got " + sizeInBytes );
		}
