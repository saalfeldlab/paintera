...
public class AffineTransform3DJsonAdapter implements JsonDeserializer< AffineTransform3D >, JsonSerializer< AffineTransform3D >
{

	@Override
	public JsonElement serialize( final AffineTransform3D transform, final Type typeOfSrc, final JsonSerializationContext context )
	{
