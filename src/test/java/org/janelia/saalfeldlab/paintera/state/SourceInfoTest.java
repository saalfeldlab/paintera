...
public class SourceInfoTest
{
	...
	private final RandomAccessibleIntervalDataSource< DoubleType, DoubleType > source1 = new RandomAccessibleIntervalDataSource<>(
			rai,
			rai,
	...
	private final RandomAccessibleIntervalDataSource< DoubleType, DoubleType > source2 = new RandomAccessibleIntervalDataSource<>(
			rai,
			rai,
			new AffineTransform3D(),
			i -> new NearestNeighborInterpolatorFactory<>(),
